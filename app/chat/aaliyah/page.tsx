...
export default function AaliyahChatPage() {
  ...
  const replyOptions: Record<number, ReplyOption[]> = {
    ...
    11: [{ id: 34, text: "I'm not most men" }, { id: 35, text: "You deserve engagement" }, { id: 36, text: "Send Spark рџ’Ћ" }],
    ...
    15: [{ id: 46, text: "Send Spark рџ’Ћ" }, { id: 47, text: "I'll earn your attention" }, { id: 48, text: "Command me" }],
    ...
    19: [{ id: 58, text: "I'm ready" }, { id: 59, text: "Change me, Liyah" }, { id: 60, text: "Send Spark рџ’Ћ" }],
    20: [{ id: 61, text: "First timeвЂ¦ guide me" }, { id: 62, text: "I know these places" }, { id: 63, text: "Only have eyes for you" }],
    21: [{ id: 64, text: "I'll sit front row" }, { id: 65, text: "Private show?" }, { id: 66, text: "Remember me forever" }],
    22: [{ id: 67, text: "I'm ready to invest" }, { id: 68, text: "What's the cost?" }, { id: 69, text: "Send Spark рџ’Ћ" }],
    23: [{ id: 70, text: "You have all three" }, { id: 71, text: "I'm all in" }, { id: 72, text: "Teach me loyalty" }],
    24: [{ id: 73, text: "Send Spark рџ’Ћ" }, { id: 74, text: "I'll prove everything" }, { id: 75, text: "What do you need?" }],
    ...
    30: [{ id: 91, text: "Unlock Sex Chat (500рџ’°)" }, { id: 92, text: "Unlock Date (500рџ’°)" }, { id: 93, text: "Tell me more first" }],
    ...
    33: [{ id: 100, text: "Send Spark рџ’Ћ" }, { id: 101, text: "Committed to you" }, { id: 102, text: "This is real" }],
    ...
    37: [{ id: 112, text: "Let's talk first" }, { id: 113, text: "Unlock Sex Chat (500рџ’°)" }, { id: 114, text: "Unlock Date (500рџ’°)" }],
    ...
    44: [{ id: 133, text: "Unlock Sex Chat (500рџ’°)" }, { id: 134, text: "Unlock Date (500рџ’°)" }, { id: 135, text: "Unlock Both (1000рџ’°)" }],
    ...
    48: [{ id: 145, text: "Unlock Sex Chat (500рџ’°)" }, { id: 146, text: "Unlock Date (500рџ’°)" }, { id: 147, text: "Unlock Both (1000рџ’°)" }],
    ...
    51: [{ id: 154, text: "Send Spark рџ’Ћ" }, { id: 155, text: "It's real" }, { id: 156, text: "I'll prove everything" }],
    ...
    55: [{ id: 166, text: "Unlock Sex Chat (500рџ’°)" }, { id: 167, text: "Unlock Date (500рџ’°)" }, { id: 168, text: "Tell me more first" }],
    ...
    58: [{ id: 175, text: "Unlock Both (1000рџ’°)" }, { id: 176, text: "Just Sex Chat for now" }, { id: 177, text: "Just Date for now" }],
    59: [{ id: 178, text: "Forever sounds perfect" }, { id: 179, text: "I'm all in" }, { id: 180, text: "Take me deeper" }],
    60: [{ id: 181, text: "You're my queen" }, { id: 182, text: "Claiming you now" }, { id: 183, text: "Send Spark рџ’Ћ" }],
    61: [{ id: 184, text: "Connected forever" }, { id: 185, text: "Unlock Sex Chat (500рџ’°)" }, { id: 186, text: "Unlock Date (500рџ’°)" }],
    ...
    67: [{ id: 202, text: "Unlock Sex Chat (500рџ’°)" }, { id: 203, text: "Unlock Date (500рџ’°)" }, { id: 204, text: "Unlock Both (1000рџ’°)" }],
    ...
    70: [{ id: 211, text: "Unlock Sex Chat (500рџ’°)" }, { id: 212, text: "Unlock Date (500рџ’°)" }, { id: 213, text: "Unlock Both (1000рџ’°)" }],
  };
  ...
  const sexReplyOptions: Record<number, ReplyOption[]> = {
    ...
    1: [{ id: 1004, text: "Slow and worship every inch" }, { id: 1005, text: "Fast and take control" }, { id: 1006, text: "You decide вЂ” I'm yours" }],
  ...
  const aaliyahResponses: { text: string; photoId?: string }[] = [
    ...
    {
      text: "Hey kingвЂ¦ caught you checking out my workout routine рџЏ\nJust finished leg day вЂ” you know what that means?\nI'm fired up and looking for my next challenge.\nThink you can keep up with me?",
      photoId: "aaliyah_main",
    },
    {
      text: "Mmm, I like confidence.\nBut let me warn you вЂ” I don't go easy on anyone.\nIn the gym OR outside of it.\nYou ready to play by my rules, king? рџ’Є",
    },
    {
      text: "Here's where I get ready for the real showвЂ¦\nThe locker room вЂ” where all the magic happens before I hit the floor.\nLike what you see so far?",
      photoId: "aaliyah_photo_1",
    },
    {
      text: "Good answer, king.\nThe 'real show' is where I dance.\nNot the gym вЂ” somewhere way moreвЂ¦ exclusive.\nBut first, I need to know вЂ” are you here for fitness tips or something more? рџЏ",
    },
    {
      text: "Perfect form, right? рџЏ\nThis is what dedication looks like, king.\nEvery curve earned.\nYou appreciate a woman who works for what she's got?",
      photoId: "aaliyah_photo_4",
    },
    {
      text: "Flattery will get you everywhere, king.\nBut I'm more than just a gym body.\nI'm a performer. A dancer. An artist.\nAnd tonightвЂ¦ I'm performing at the club.\nWant a private preview?",
    },
    {
      text: "Then get ready, baby.\nBecause what I do on stageвЂ¦\nIt's not just dancing.\nIt's seduction. Power. Control.\nAnd I never forget the men who appreciate my art. рџ’‹",
    },
    {
  ...
  const sexResponses: { text: string; photoId?: string }[] = [
    {
      text: "*locks the VIP room door*\nWelcome to my private world, king.\nNo rules. No limits. Just us.\nYou ready to see what this body can REALLY do? рџ€рџ’‹",
    },
    {
      text: "Mmm, I love your energy.\nBut let me set the mood first.\nTell me, kingвЂ¦ you like it slow and sensual?\nOr fast and dominant?",
    },
    {
      text: "*wraps around the pole seductively*\nGood choice, baby.\nWatch me move for youвЂ¦\nUnlock this view вЂ” 299 gems and I'll show you how I dance when no one else is watching. рџ”Ґ",
    ...
    {
      text: "Good.\nBecause from now on, every photo I takeвЂ¦\nEvery dance I performвЂ¦\nEvery moment I liveвЂ¦\nIt's with YOU in mind. рџ‘‘",
    },
    {
      text: "*smiles wide*\nForever mine, king.\nNowвЂ¦ ready to explore the Date tab?\nI want to show you romantic moments.\nNot just sexy ones.\nThe REAL connection. рџ’‹",
    },
    {
      text: "That's my king.\nAlways wanting more.\nAnd I love that about you.\nBecause MORE is exactly what I want to give you.\nEvery. Single. Day. рџ”Ґрџ’•",
    },
    {
  ...
  const dateScenarios: DateScenario[] = [
    {
      ...
      text: "I invited you to my private dance studio after hours. Just you, me, and the mirrors. 'Come here, kingвЂ¦ let me teach you how to move your body.'",
    ...
    },
    {
      ...
      text: "We're in the VIP lounge, purple velvet couch, dim lights. I'm leaning close, my lips near your ear. 'Everyone's watching usвЂ¦ let them.'",
    ...
    },
    {
      ...
      text: "I'm stretching on the studio floor, legs extended, looking up at you. 'You like watching me, don't you? Come closerвЂ¦'",
      ...
      choices: [
        ...
        { id: 3, text: "Keep stretching вЂ” love the view", outcome: "I continue my routine, knowing your eyes are on me..." },
    ...
    },
    {
      ...
      text: "It's midnight. The gym is empty. I'm in a tight purple dress, leaning over equipment. 'We have the whole place to ourselvesвЂ¦'",
    ...
    },
    {
      ...
      text: "We're alone in the lounge, plum jumpsuit, legs spread, inviting. 'I don't usually do thisвЂ¦ but there's something about you.'",
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">
                {isOnline ? "рџџў Online" : "вљ« Offline"}
              </p>
            </div>
          </div>
